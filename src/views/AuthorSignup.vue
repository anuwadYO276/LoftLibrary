    ...
    <div class="flex bg-custombg rounded-md overflow-hidden w-full max-w-4xl shadow-lg">
      ...
      <div class="w-1/2 p-8 flex flex-col justify-center items-center border-r border-gray-700">
        ...
        <p class="text-center text-sm text-customwhite mb-6">
          We are so excited to have you here. <br>
          If you haven't already, create an account to <br>get access to exclusive offers.
        </p>
      ...
      <!-- Right Section -->
      <div class="w-1/2 p-8">
        <h1 class="text-cyan-custom text-2xl font-semibold mb-6 text-center">Loft Author Signup</h1>
        <form @submit.prevent="submitSignup" class="space-y-5">
          ...
          <div>
            <label for="penname" class="block mb-1 text-sm">Penname</label>
            <input
              id="penname"
              v-model="penname"
              type="text"
